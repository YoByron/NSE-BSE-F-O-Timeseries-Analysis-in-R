...
p + geom_bar(aes(fill = net_FII), stat = "identity") + theme_dark() + labs(x = "Date", y = "Gross Purchase (Crores)",subtitle = paste("Last updated",Sys.time())) + geom_text(aes(label=net_FII+net_DII),colour='#D2CCA1') + guides(x = guide_axis(n.dodge = 2))  
}
```
