...
#labs(x = "Date", title = "Gross Purchase FII+DII (Crores)",
#       y = "Gross Purchase (Crores)",subtitle = paste("Last #updated",Sys.time())) 

p + geom_bar(aes(fill = net_FII), stat = "identity") +  theme(legend.position = "right")
