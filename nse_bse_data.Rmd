...
---
## <span style='color: #1d7874'>NSE Option Chain.

```{python optionschain, echo=FALSE, ,echo=FALSE, error=FALSE, message=FALSE, warning=FALSE,tidy=TRUE}
...
## <span style='color: #1d7874'> Most Traded Stocks
...
```{python nifty_pe, include=TRUE, echo=FALSE, tidy=TRUE}
...
## NIFTY PE
```{r pythoncall, echo=FALSE, error=FALSE, warning=FALSE, paged.print=FALSE, results='asis', tidy=TRUE}
library(reticulate)
#py_available(TRUE)
pythonr <- py$nifty_pe
knitr::kable(pythonr)%>%
...
print(rbi)
```
```{r rbi_data, echo=FALSE, error=FALSE, warning=FALSE, paged.print=FALSE, results='hold', tidy=TRUE}

library(reticulate)
#py_available(TRUE)
python_rbi <- py$rbi
knitr::kable(python_rbi)%>%
  kable_styling(bootstrap_options = "condensed",
                , full_width = F
                ,font_size = 12,
                fixed_thead = T)%>%
scroll_box(width = "80%", height = "30%")
```

## <span style='color: #1d7874'>NSE FO Heatmap (disabled)
```{r nse_fo_heatmp, echo=FALSE, error=FALSE, warning=FALSE, paged.print=FALSE, results='hold', tidy=TRUE}
#nsetree("fo")
``` 

## <span style='color: #1d7874'>Stock Price Chart
