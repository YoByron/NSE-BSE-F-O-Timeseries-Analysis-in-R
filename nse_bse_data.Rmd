...
## <span style='color: #FCC780'>Preopen NSE FO Markets
###  <span style='color: #FF5733'> NSE FO Top Gainers
```{r nse_fo_top_gainers, echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
#NSE Markets
#library(nse2r)
...
#fixed_header = list(enabled = T, background = "green")
```

###   <span style='color: #FFA1A1'> NSE FO Top Losers
...
##  <span style='color: #FCC780'> NSE Indices (Preopen Nifty, Nifty Bank disabled)
### Preopen Nifty
...
knitr::kable(nse_index_quote(clean_names = TRUE))%>%
  kable_styling(bootstrap_options = "condensed",
                ...
                ,font_size = 12,
                fixed_thead = T)%>%
scroll_box(width = "50%", height = "50%")
```

## <span style='color: #FCC780'> Most Traded Stocks
...
## <span style='color: #FCC780'>NSE IPO  
...
## <span style='color: #FCC780'>NSE Cash Market
...
## <span style='color: #FCC780'>RBI Current Data
